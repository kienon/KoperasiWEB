          ...
          <div class="card">
            <div class="card-body"><br>
              ...
              <input name="id" type="hidden" value="<?php echo $row['id'];?>" />
                <div class="row mb-3">
                  <label for="inputname" class="col-sm-2 col-form-label">Perkidmatan</label>
                  <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" id="inputText" value="<?php echo $row['name'] ?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inpuCount" class="col-sm-2 col-form-label">Jumlah</label>
                  <div class="col-sm-10">
                ...
                <div class="text-center">
                  <a href="admin-counter" class="btn btn-secondary">Kembali</a>
